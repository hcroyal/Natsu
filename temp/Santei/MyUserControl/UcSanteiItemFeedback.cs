...
namespace Natsu.MyUserControl
{
    ...
    public partial class UcSanteiItemFeedback : UserControl
    {
        //public event AllTextChange Changed;

        public UcSanteiItemFeedback()
        {
            InitializeComponent();
        }
        ...
        public void LoadData(tbl_DESO_Backup data)
        {
            ...
            txt_TruongSo19.Text = data.Truong_19;
            txt_TruongSo20.Text = data.Truong_20;
            txt_TruongSo21.Text = data.Truong_21;
            txt_TruongSo22.Text = data.Truong_22;
            txt_TruongSo23.Text = data.Truong_23;

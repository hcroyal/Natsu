        ...
        public bool TableToExcel(string strfilename)
        {
            try
            {
                ...
                foreach (DataGridViewRow dr in dataGridView1.Rows)
                {
                    ...
                    wrksheet.Cells[h, 9] = dr.Cells[6].Value?.ToString() ?? "";
                    wrksheet.Cells[h, 10] = dr.Cells[7].Value?.ToString() ?? "";
                    wrksheet.Cells[h, 11] = dr.Cells[8].Value?.ToString() ?? "";
                    wrksheet.Cells[h, 12] = dr.Cells[9].Value?.ToString() ?? "";
                    wrksheet.Cells[h, 13] = dr.Cells[10].Value?.ToString() ?? "";
                    wrksheet.Cells[h, 14] = dr.Cells[11].Value?.ToString() ?? "";

                    if ((dr.Cells[12].Value?.ToString() ?? "").Length == 4)
                    {
                    ...
                    wrksheet.Cells[h, 17] = dr.Cells[13].Value?.ToString() ?? "";
                    wrksheet.Cells[h, 18] = dr.Cells[14].Value?.ToString() ?? "";
                    wrksheet.Cells[h, 19] = dr.Cells[15].Value?.ToString() ?? "";
                    wrksheet.Cells[h, 20] = dr.Cells[16].Value?.ToString() ?? "";
                    wrksheet.Cells[h, 21] = dr.Cells[17].Value?.ToString() ?? "";
                    wrksheet.Cells[h, 22] = dr.Cells[18].Value?.ToString() ?? "";
                    wrksheet.Cells[h, 23] = dr.Cells[19].Value?.ToString() ?? "";
                    wrksheet.Cells[h, 24] = dr.Cells[20].Value?.ToString() ?? "";
                    wrksheet.Cells[h, 25] = dr.Cells[21].Value?.ToString() ?? "";
                    wrksheet.Cells[h, 26] = dr.Cells[22].Value?.ToString() ?? "";
                    wrksheet.Cells[h, 27] = dr.Cells[23].Value?.ToString() ?? "";
                    wrksheet.Cells[h, 28] = dr.Cells[24].Value?.ToString() ?? "";
                ...
                saveFileDialog1.FileName = cbb_Batch.Text + "_Getsu";
